...
#model_path = '../ML_models/xgboost_breast_cancer_model.joblib'  # Update the path if needed
model_path = os.path.join(os.path.dirname(__file__), '../ML_models/xgboost_breast_cancer_model.joblib')
